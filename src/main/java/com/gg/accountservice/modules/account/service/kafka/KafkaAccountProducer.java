...
import com.gg.accountservice.modules.account.dto.kafka.AccountPayload;
import com.gg.accountservice.modules.account.dto.kafka.Fields;
...
import com.gg.accountservice.modules.account.records.KafkaAccountDto;
...
public class KafkaAccountProducer {
    ...
    private final List<Fields> fields = Arrays.asList(new Fields("string", true, "account_id"), new Fields("string", true, "username"),
        new Fields("string", true, "nickname"), new Fields("string", true, "email"), new Fields("string", true, "password"),
        new Fields("string", true, "login_type"), new Fields("int32", true, "age"), new Fields("int32", true, "birth"),
        new Fields("string", true, "account_status"), new Fields("string", true, "profile_image"), new Fields("string", true, "joined_at"),
        new Fields("int32", true, "auth_code"), new Fields("int32", true, "login_count"), new Fields("int32", true, "login_fail_count"),
